...
public final class PluginUpdateLocale implements UpdateLocale {
    ...
    public void updateVariables(String pluginName, String oldVersion, String newVersion) throws IllegalAccessException {
        ...
        for (Field field : PluginUpdateLocale.class.getDeclaredFields()) {
    ...
    public static class UpdateLocaleBuilder implements LocaleBuilder {
        ...
        private String updatingMsg = "&f&lUPDATING &1&l%plugin% &b&l%old_version% &a&l» &b&l%new_version%";
        private String updatingMsgNoVar = "&f&lUPDATING PLUGIN...";
        private String downloadingMsg = "&f&lDOWNLOADING &1&l%plugin% &b&l%new_version% &8| %download_bar% &8| &a%download_percent%";
        private String completionMsg = "&f&lUPDATED &1&l%plugin% &f&lTO &b&l%new_version% &7&o(%elapsed_time%s)";
        private String failureMsg = "&c&lUPDATE FAILED";
